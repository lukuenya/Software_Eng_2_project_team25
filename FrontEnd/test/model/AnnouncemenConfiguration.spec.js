...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnnouncemenConfiguration', function() {
      beforeEach(function() {
        instance = new NineToFiveApi.AnnouncemenConfiguration();
      });

      it('should create an instance of AnnouncemenConfiguration', function() {
        // TODO: update the code to test AnnouncemenConfiguration
        expect(instance).to.be.a(NineToFiveApi.AnnouncemenConfiguration);
      });
