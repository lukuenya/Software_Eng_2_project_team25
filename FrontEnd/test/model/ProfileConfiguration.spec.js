...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProfileConfiguration', function() {
      beforeEach(function() {
        instance = new NineToFiveApi.ProfileConfiguration();
      });

      it('should create an instance of ProfileConfiguration', function() {
        // TODO: update the code to test ProfileConfiguration
        expect(instance).to.be.a(NineToFiveApi.ProfileConfiguration);
      });
